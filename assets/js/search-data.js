...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "cv",
          description: "A bit about my professional history",
          section: "Navigation",
          handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-graduated-with-a-m-s-in-cybersecurity-from-georgia-institute-of-technology",
          title: 'Graduated with a M.S. in Cybersecurity from Georgia Institute of Technology.',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%68%65%6C%6C%6F@%62%72%61%6E%64%6F%6E-%77%75.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/brandonwu", "_blank");
        },
      },{
        id: 'social-work',
        title: 'Work',
